...
% run2
attnEnAutism1 = zeros(8*48,16); % 8 - #electrode, 15 - # day, excluding e32
attnEnControl1 = zeros(8*48,16); % 8 - #electrode, 15 - # day, excluding e32
...
title('Mean-AttnEn of Plate1 & Plate3, IGF');
